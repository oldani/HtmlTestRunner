...
The sources for HtmlTestRunner can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/oldani/HtmlTestRunner
.. _tarball: https://github.com/oldani/HtmlTestRunner/tarball/master
